...
```{r equate groups based on artifacts}
...
y= scale(demo$psd_identifiability)
x= scale(demo$Age)
x1= scale(volume)
x2= scale(log10(rowMeans(artifacts)))
...
ggsave('C:/Users/J Da Silva Castanhei/Documents/SickKidz_fingerprinting/R_figures/2024scatter_ICC_matched.pdf', device = "pdf", width = 5, height = 5)
