...
setwd('C:/Users/J Da Silva Castanhei/Downloads/SickKidsCode/SickKidsCode/')
...
ggsave('~/Documents/CAMCAN_outputs/figures/50dPpl_Aperiodiccorr_genecorr_continuous_mergedCohorts_POLY3rd.pdf', device = "pdf", width= 10, height =10)
...
(sum(0.78< beta3)+1)/1001 # 0.001998002
...
(sum(0.73< beta3)+1)/1001 # 0.003996004
